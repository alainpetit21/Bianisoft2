...
public class ScnNode_DrawableObj_AnimateAlpha extends ScenaricNode{
	Drawable	m_drawableObj;
	float		m_fInc= 0.05f;
	float		m_fValue= 1.0f;


	public ScnNode_DrawableObj_AnimateAlpha(Drawable p_drawableObj){
	...
	public boolean manage(float p_fTimeTick){
		...
		m_drawableObj.setFilterAlpha(m_fValue);
	...
	public void stop(){
		...
		m_drawableObj.setFilterAlpha(m_fValue= 1.0f);
	}
}
