...
public class Renderer {		
	...
	/** The renderer in use */
	private static I_SGL renderer = new ImmediateModeOGLRenderer();
	/** The line strip renderer to use */
	private static I_LineStripRenderer lineStripRenderer = new DefaultLineStripRenderer();
	 ...
	 */
	public static void setLineStripRenderer(I_LineStripRenderer renderer) {
	 ...
	 */
	public static void setRenderer(I_SGL r) {
		renderer = r;
	}
	 ...
	 */
	public static I_LineStripRenderer getLineStripRenderer() {
