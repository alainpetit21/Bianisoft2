...
public class AudioLoader {
	 ...
	 */
	public static I_Audio getAudio(String format, InputStream in) throws IOException {
		init();
	 ...
	 * @throws IOException Indicates a failure to access the audio data
	 */
	public static I_Audio getStreamingAudio(String format, URL url) throws IOException {
		init();
