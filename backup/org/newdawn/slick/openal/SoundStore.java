...
public class SoundStore {
	 ...
	 */
	public I_Audio getMOD(String ref) throws IOException {
	 ...
	 * @throws IOException Indicates a failure to read the data
	 */
	public I_Audio getMOD(InputStream in) throws IOException {
	 ...
	 * @throws IOException Indicates a failure to read the data
	 */
	public I_Audio getMOD(String ref, InputStream in) throws IOException {
		if (!soundWorks) {
	 ...
	 */
	public I_Audio getAIF(String ref) throws IOException {
	 ...
	 * @throws IOException Indicates a failure to load the AIF
	 */
	public I_Audio getAIF(InputStream in) throws IOException {
	 ...
	 * @throws IOException Indicates a failure to load the AIF
	 */
	public I_Audio getAIF(String ref, InputStream in) throws IOException {
	 ...
	 */
	public I_Audio getWAV(String ref) throws IOException {
	 ...
	 * @throws IOException Indicates a failure to load the WAV
	 */
	public I_Audio getWAV(InputStream in) throws IOException {
	 ...
	 * @throws IOException Indicates a failure to load the WAV
	 */
	public I_Audio getWAV(String ref, InputStream in) throws IOException {
		if (!soundWorks) {
			return new NullAudio();
		}
		if (!inited) {
	 ...
	 */
	public I_Audio getOggStream(String ref) throws IOException {
		if (!soundWorks) {
			return new NullAudio();
		}
	 ...
	 * @throws IOException Indicates a failure to load the OGG
	 */
	public I_Audio getOggStream(URL ref) throws IOException {
		if (!soundWorks) {
			return new NullAudio();
		}
	 ...
	 * @throws IOException Indicates a failure to load the OGG
	 */
	public I_Audio getOgg(String ref) throws IOException {
	 ...
	 * @throws IOException Indicates a failure to load the OGG
	 */
	public I_Audio getOgg(InputStream in) throws IOException {
	 ...
	 * @throws IOException Indicates a failure to load the OGG
	 */
	public I_Audio getOgg(String ref, InputStream in) throws IOException {
		if (!soundWorks) {
			return new NullAudio();
		}
		if (!inited) {
